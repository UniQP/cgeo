...
public enum LogType {
    ...
    UNARCHIVE(12, "Unarchive", "", R.string.log_unarchived, R.drawable.mark_green_more),
    TEMP_DISABLE_LISTING(22, "Temporarily Disable Listing", "Temporarily unavailable", R.string.log_disabled, R.drawable.mark_red_more),
    ...
    UPDATE_COORDINATES(47, "Update Coordinates", "Moved", R.string.log_update, R.drawable.marker_owner_maintenance),
    DISCOVERED_IT(48, "Discovered It", "", R.string.log_discovered, R.drawable.mark_green),
    POST_REVIEWER_NOTE(18, "Post Reviewer Note", "", R.string.log_reviewer),
    SUBMIT_FOR_REVIEW(76, "submit for review", "", R.string.log_submit_for_review),
    VISIT(1001, "visit", "", R.string.log_tb_visit, R.drawable.mark_green),
    WEBCAM_PHOTO_TAKEN(11, "Webcam Photo Taken", "", R.string.log_webcam, R.drawable.mark_green, R.drawable.marker_found_offline),
    ANNOUNCEMENT(74, "Announcement", "", R.string.log_announcement),
    ...
    LogType(final int id, @NonNull final String type, @NonNull final String ocType,
    ...
    LogType(final int id, final String type, final String ocType, final int stringId,
            final int markerId) {
        this(id, type, ocType, stringId, markerId, 0);
    }

    LogType(final int id, final String type, final String ocType, final int stringId) {
        this(id, type, ocType, stringId, R.drawable.mark_gray);
    }
